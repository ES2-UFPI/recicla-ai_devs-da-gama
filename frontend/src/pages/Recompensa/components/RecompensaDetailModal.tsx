...
export function RecompensaDetailModal({
  ...
  const temPontosParaResgatar = userPoints >= recompensa.pontos_necessarios;
          ...
          <Grid size={{ xs: 12, md: 7 }}>
            <Box sx={{ p: 3 }}>
              ...
              <Paper
                ...
                sx={{
                  p: 2,
                  bgcolor: temPontosParaResgatar ? 'success.50' : 'error.50',
                  borderRadius: '0.75rem',
                  mb: 2,
                }}
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                  <StarsIcon color={temPontosParaResgatar ? 'success' : 'error'} />
