...
class Scheduling(BaseModel):
    ...
    coleta_integral: bool = Field(default=False, description="Define se a coleta deve ser integral (True = todos os resíduos obrigatórios) ou parcial (False = alguns resíduos)")
